...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-d1b986ea.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-d1b986ea.js", "/./_app/chunks/vendor-45a1b6ab.js", "/./_app/chunks/singletons-bb9012b7.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-d134654c.js", "css": ["/./_app/assets/pages/__layout.svelte-ff66e680.css"], "js": ["/./_app/pages/__layout.svelte-d134654c.js", "/./_app/chunks/vendor-45a1b6ab.js", "/./_app/chunks/stores-668225f0.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-423024a4.js", "css": [], "js": ["/./_app/error.svelte-423024a4.js", "/./_app/chunks/vendor-45a1b6ab.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-63f94eb9.js", "css": ["/./_app/assets/pages/index.svelte-4334bc98.css"], "js": ["/./_app/pages/index.svelte-63f94eb9.js", "/./_app/chunks/vendor-45a1b6ab.js", "/./_app/chunks/stores-668225f0.js", "/./_app/chunks/singletons-bb9012b7.js"], "styles": null}};
...
var ReloadPrompt = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  toast = needRefresh;
  return `${toast ? `<section class="${"z-max absolute pv5 right-1 bottom-1 w-80 w-80-ns w-80-m w-two-thirds-l mr-auto ml-auto "}" role="${"alert"}"><article style="${"background-color:#ebdcc8"}" class="${"mw8 center br3 br3-ns br3-m br4-l shadow-5"}"><div class="${"dt-ns dt--fixed-ns w-100"}"><div class="${"pa3 pa4-ns pr0 dtc-ns v-mid w-100 w-100-ns w-50-m w-60-l"}"><div>
          <h2 class="${"f4 fw6 golden-brown mt0 mb0 svelte-zj5q24"}">I Viaggi Di Maurizio\xA0Levi</h2>
          ${`
            <p class="${"black-70 measure lh-copy mv0"}">More offers available now\u2026</p>`}</div></div>


      ${``}
      <div class="${"pa2 dtc-ns v-mid w-100 w-100-ns w-20-m w-10-l"}"><button class="${"input-reset pointer bn f4 tc db w-100 transition hover-bg-white bg-near-white golden-brown br2 br2-ns br2-m br3-l pv2 pv2-ns pv4-m pv3-l o-70 hover-o-100 svelte-zj5q24"}">Later</button></div></div></article></section>` : ``}
...
<aside class="${"z-max w5 pa2  svelte-1fnm9pu"}">
<dl class="${"list pl0"}"><dt>pageStore:</dt><dd>${escape2($pageStore)}</dd><dt>currentPageStore:</dt><dd>${escape2($currentPageStore)}</dd><dt>prefLang:</dt><dd>${escape2($prefLang)}</dd></dl>
...
var Hero = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<figure class="${"ma0 flex flex-column vh-75 w-100 gold cover"}" style="${"background-position:center 40%; background-image: url('./images/base64-planck.svg')"}"><div class="${"vh-75 flex items-center invert w-100 f5 f4-ns f3-m f3-l measure pa2 measure-ns pa4-ns measure-m pa2-m measure-wide-l pa0-l mr-auto ml-auto"}"><div class="${"flex flex-column w-100 pt5 pt6-l"}"><h1 class="${"tracked-none tracked-ns tracked-m tracked-mega-l f7 f7-ns f5-m f4-l fw5 ttu tc mv0"}">Subheading</h1>
				<h2 class="${"w-100 mv0 ph3 f2 f2-ns f1-m f1-l tc lh-solid"}">Cile</h2></div></div>
...
<nav class="${"bg-black-60 backdrop-blur fixed z-9999 w-100 top-0 landscape-top-0-ns landscape-top-0-m landscape-top-0-l flex debug svelte-zv1ugh"}">
<div class="${"w-100 flex items-center justify-between fw6 f4 f3-ns f3-m f3-l measure measure-ns measure-m measure-wide-l mr-auto ml-auto svelte-zv1ugh"}"><div class="${"w-40 w-50-ns w-50-m w-20-l pv3 h3 svelte-zv1ugh"}">
	<h1 class="${"fw6 f4 f3-ns f3-m f3-l mv0 gold svelte-zv1ugh"}">${each(pageItems, (item, i) => {
    return `${i === 0 ? `<a${add_attribute("href", `#${item.title.toLowerCase().replace(/\s/g, "-")}`, 0)} class="${[
      "link w-third hover-near-white pointer light-gray ts1-dark-gray fw8 ml-auto mr-auto pv3 h3 transition relative hover-ltr o-80 svelte-zv1ugh",
	...
	<div class="${"w-50-l justify-between dn landscape-flex-l tc svelte-zv1ugh"}">${each(pageItems, (item, i) => {
    return `${i >= 1 ? `<a${add_attribute("href", `#${item.title.toLowerCase().replace(/\s/g, "-")}`, 0)}${add_attribute("title", item.title, 0)} class="${[
      "link hover-near-white pointer light-gray ts1-dark-gray pv3 h3 transition relative hover-ltr o-80 svelte-zv1ugh",
	...
	<div class="${"w-60 w-50-ns w-50-m w-30-l flex flex-row justify-end tr svelte-zv1ugh"}"><button class="${[
    "truncate hover-near-white pointer light-gray ts1-dark-gray pv3 h3 o-80 bn br0 bg-transparent svelte-zv1ugh",
    $prefLang == "it" ? "b" : ""
...
<nav class="${"bg-black-60 backdrop-blur fixed z-9999 w-100 bottom-0 portrait-bottom-0-ns portrait-bottom-0-m portrait-bottom-0-l landscape-dn-l flex tc debug svelte-zv1ugh"}">
<div class="${"w-100 flex justify-between fw6 f4 f3-ns f3-m f3-l lh-copy measure measure-ns measure-m measure-wide-l mr-auto ml-auto svelte-zv1ugh"}">
