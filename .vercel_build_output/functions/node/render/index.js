...
function init(settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: "/./_app/start-4d7d8aaf.js",
      css: ["/./_app/assets/start-a8cd1609.css"],
      js: ["/./_app/start-4d7d8aaf.js", "/./_app/chunks/vendor-c5c54f60.js", "/./_app/chunks/singletons-bb9012b7.js"]
    },
    fetched: void 0,
    floc: false,
...
var metadata_lookup = {"src/routes/__layout.svelte": {"entry": "/./_app/pages/__layout.svelte-1ae45886.js", "css": ["/./_app/assets/pages/__layout.svelte-ff66e680.css"], "js": ["/./_app/pages/__layout.svelte-1ae45886.js", "/./_app/chunks/vendor-c5c54f60.js", "/./_app/chunks/stores-548c6124.js"], "styles": null}, ".svelte-kit/build/components/error.svelte": {"entry": "/./_app/error.svelte-2f817f5f.js", "css": [], "js": ["/./_app/error.svelte-2f817f5f.js", "/./_app/chunks/vendor-c5c54f60.js"], "styles": null}, "src/routes/index.svelte": {"entry": "/./_app/pages/index.svelte-e6f7706d.js", "css": ["/./_app/assets/pages/index.svelte-294ef217.css"], "js": ["/./_app/pages/index.svelte-e6f7706d.js", "/./_app/chunks/vendor-c5c54f60.js", "/./_app/chunks/stores-548c6124.js", "/./_app/chunks/singletons-bb9012b7.js"], "styles": null}};
...
<nav class="${"bg-black-60 backdrop-blur fixed z-9999 w-100 top-0 landscape-top-0-ns landscape-top-0-m landscape-top-0-l flex svelte-mrnzgn"}">
<div class="${"w-100 flex items-center justify-between fw6 f4 f3-ns f3-m f3-l measure measure-ns measure-m measure-wide-l mr-auto ml-auto"}"><div class="${"w-40 w-50-ns w-50-m w-20-l h3"}">
	<h1 class="${"fw6 f4 f3-ns f3-m f3-l mv0 gold"}">${each(pageItems, (item, i) => {
    return `${i === 0 ? `
		<a style="${"background: transparent!important"}"${add_attribute("href", `#${item.title.toLowerCase().replace(/\s/g, "-")}`, 0)} class="${"link w-third hover-near-white pointer light-gray ts1-dark-gray fw8 ml-auto mr-auto h3 transition relative svelte-mrnzgn"}"${add_attribute("title", item.title, 0)}><img class="${"w4"}" src="${"./images/logo.png"}"${add_attribute("alt", item.title, 0)}>
			
		</a>` : ``}`;
  })}</h1></div>

	
	<div class="${"w-50-l justify-between dn landscape-flex-l tc svelte-mrnzgn"}">${each(pageItems, (item, i) => {
    return `${i >= 1 ? `<a${add_attribute("href", `#${item.title.toLowerCase().replace(/\s/g, "-")}`, 0)}${add_attribute("title", item.title, 0)} class="${[
      "link hover-near-white pointer light-gray ts1-dark-gray pv3 h3 transition relative hover-ltr o-80 svelte-mrnzgn",
	...
	<div class="${"flex justify-between"}"><input id="${"search"}" type="${"search"}" name="${"search"}" placeholder="${"Search"}" data-placeholder="${"Cerca"}" style="${"border-top:none;border-right:none;border-left:none"}" class="${"white bg-transition input-reset br0 bb bw2 w-two-thirds w-75-l bg-transparent b--black f6 f5-ns pv3 db pa3 pl1"}">
		<button class="${"white br0 ba bw2 w-third w-25-l bg-black b--black hover-bg-golden-brown transition f6 f5-ns pointer ph0 "}">
			<svg viewBox="${"0 0 24 24"}" class="${"h2 no-select"}"><use xlink:href="${"#icon-search"}"></use></svg></button></div></div></nav>




<nav class="${"bg-black-60 backdrop-blur fixed z-9999 w-100 bottom-0 portrait-bottom-0-ns portrait-bottom-0-m portrait-bottom-0-l landscape-dn-l flex tc svelte-mrnzgn"}">
<div class="${"w-100 flex justify-between fw6 f4 f3-ns f3-m f3-l lh-copy measure measure-ns measure-m measure-wide-l mr-auto ml-auto"}">
