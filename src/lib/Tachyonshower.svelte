...
.hover-soccorso:hover,
.hover-soccorso:focus {
  color: var(--soccorso);
}
.hover-bg-soccorso:hover,
.hover-bg-soccorso:focus {
  background-color: var(--soccorso);
}
...
.hover-mandarino:hover,
.hover-mandarino:focus {
  color: var(--mandarino);
}
.hover-bg-mandarino:hover,
.hover-bg-mandarino:focus {
  background-color: var(--mandarino);
}
...
.hover-egyptian:hover,
.hover-egyptian:focus {
  color: var(--egyptian);
}
.hover-bg-egyptian:hover,
.hover-bg-egyptian:focus {
  background-color: var(--egyptian);
}
...
.hover-electric-lime:hover,
.hover-electric-lime:focus {
  color: var(--electric-lime);
}
.hover-bg-electric-lime:hover,
.hover-bg-electric-lime:focus {
  background-color: var(--electric-lime);
}
...
.hover-raspberry:hover,
.hover-raspberry:focus {
  color: var(--raspberry);
}
.hover-bg-raspberry:hover,
.hover-bg-raspberry:focus {
  background-color: var(--raspberry);
}
...
.hover-bg-prussia:hover,
.hover-bg-prussia:focus {
  background-color: var(--prussia);
}
...
.hover-caribbean:hover,
.hover-caribbean:focus {
  color: var(--caribbean);
}
.hover-bg-caribbean:hover,
.hover-bg-caribbean:focus {
  background-color: var(--caribbean);
}
...
.hover-mexicano:hover,
.hover-mexicano:focus {
  color: var(--mexicano);
}
.hover-bg-mexicano:hover,
.hover-bg-mexicano:focus {
  background-color: var(--mexicano);
}
...
.hover-bg-pm-blue:hover,
.hover-bg-pm-blue:focus {
  background-color: var(--pm-blue);
}
...
.hover-pm-blue-dark:hover,
.hover-pm-blue-dark:focus {
  color: var(--pm-blue-dark);
}
.hover-bg-pm-blue-dark:hover,
.hover-bg-pm-blue-dark:focus {
  background-color: var(--pm-blue-dark);
}
...
.hover-pm-blue-light:hover,
.hover-pm-blue-light:focus {
  color: var(--pm-blue-light);
}
.hover-bg-pm-blue-light:hover,
.hover-bg-pm-blue-light:focus {
  background-color: var(--pm-blue-light);
}
.vimeo {
  color: var(--vimeo);
...
.hover-tripadvisor:hover,
.hover-tripadvisor:focus {
  color: var(--tripadvisor);
}
.hover-bg-tripadvisor:hover,
.hover-bg-tripadvisor:focus {
  background-color: var(--tripadvisor);
}
.whatsapp {
  color: var(--whatsapp);
...
.hover-dark-beige:hover,
.hover-dark-beige:focus {
  color: var(--dark-beige);
}
.hover-bg-dark-beige:hover,
.hover-bg-dark-beige:focus {
  background-color: var(--dark-beige);
}
...
.hover-dim-gray:hover,
.hover-dim-gray:focus {
  color: #444;
}
.hover-bg-dim-gray:hover,
.hover-bg-dim-gray:focus {
  background-color: #444;
}
...
.hover-charcoal:focus {
  color: var(--charcoal);
}
.hover-bg-charcoal:hover,
.hover-bg-charcoal:focus {
  background-color: var(--charcoal);
}
...
.hover-magnolia:hover,
.hover-magnolia:focus {
  color: var(--magnolia);
}
.hover-bg-magnolia:hover,
.hover-bg-magnolia:focus {
  background-color: var(--magnolia);
}
...
.hover-bg-tyrian:hover,
.hover-bg-tyrian:focus {
  background-color: var(--tyrian);
}
...
.hover-bg-beacon:hover,
.hover-bg-beacon:focus {
  background-color: #F15A22;
}
...
.hover-bg-oxford:hover,
.hover-bg-oxford:focus {
  background-color: var(--oxford);
}
...
.hover-bg-dark-lime:hover,
.hover-bg-dark-lime:focus {
  background-color: #66a61e;
}
...
.hover-lilac-flower:hover,
.hover-lilac-flower:focus {
  color: #7570b3;
}
.hover-bg-lilac-flower:hover,
.hover-bg-lilac-flower:focus {
  background-color: #7570b3;
}
...
.hover-disco-pink:hover,
.hover-disco-pink:focus {
  color: #e7298a;
}
.hover-bg-disco-pink:hover,
.hover-bg-disco-pink:focus {
  background-color: #e7298a;
}
...
.hover-education:focus {
  color: var(--education);
}
.hover-bg-education:hover,
.hover-bg-education:focus {
  background-color: var(--education);
}
...
.hover-transport:focus {
  color: var(--transport);
}
.hover-bg-transport:hover,
.hover-bg-transport:focus {
  background-color: var(--transport);
}
...
.hover-bg-shelter:hover,
.hover-bg-shelter:focus {
  background-color: var(--shelter);
}
...
.hover-national:hover,
.hover-national:focus {
  color: var(--national);
}
.hover-bg-national:hover,
.hover-bg-national:focus {
  background-color: var(--national);
}
...
.hover-regional:hover,
.hover-regional:focus {
  color: var(--regional);
}
.hover-bg-regional:hover,
.hover-bg-regional:focus {
  background-color: var(--regional);
}
...
.hover-institution:hover,
.hover-institution:focus {
  color: var(--institution);
}
.hover-bg-institution:hover,
.hover-bg-institution:focus {
  background-color: var(--institution);
}
...
.hover-community:hover,
.hover-community:focus {
  color: var(--community);
}
.hover-bg-community:hover,
.hover-bg-community:focus {
  background-color: var(--community);
}
...
.hover-deep-petrol:focus {
  color: #2F3B53;
}
.hover-bg-deep-petrol:hover,
.hover-bg-deep-petrol:focus {
  background-color: #2F3B53;
}
.petrol {
  color: #445576;
...
[aria-expanded=false]~#menu nav {
  -webkit-transform: translateX(100%);
  transform: translateX(100%);
}
[aria-expanded=true]~#menu nav {
  -webkit-transform: translateX(0);
  transform: translateX(0);
}
#menu .overlay {
...
@media all and (orientation:landscape) {
  ...
  @media screen and (min-width: 30em) {
    .landscape-bottom-0-ns {
      bottom: 0;
    }
  }
  @media screen and (min-width: 30em) and (max-width: 60em) {
    .landscape-bottom-0-m {
      bottom: 0;
    }
  }
  @media screen and (min-width: 60em) {
    .landscape-bottom-0-l {
      bottom: 0;
    }
  }
  .landscape-vh-50 {
...
.link.emojisymbol:before {
  content: "\1F517";
}

/* https://unicode-table.com/en/1F517/ */
.phone.emojisymbol:before {
  content: "\2706";
  /* \1F4DE */
}
.mail.emojisymbol:before {
  content: "\1F582";
}
.important.emojisymbol:before {
  content: "\27BD";
}
.alert.emojisymbol:before {
  content: "\26A0";
}
.emojisymbol:before {
  font-family: sans-serif,
